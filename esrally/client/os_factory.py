...
from esrally.client.os_client import RallyAsyncOpenSearch
...
class OsClientFactory:
    ...
    def create_async(self):
        # pylint: disable=import-outside-toplevel
        import opensearchpy
        import esrally.client.asynchronous as RallyAsync
        import io
        import aiohttp
        ...
        return RallyAsyncOpenSearch(hosts=self.hosts,
                                    connection_class=RallyAsync.AIOHttpConnection,
