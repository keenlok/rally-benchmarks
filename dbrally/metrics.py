...
from dbrally import client, config, exceptions, paths, time, types, version
from dbrally.utils import console, convert, io, versions
...
def percentiles_for_sample_size(sample_size):
    ...
    if sample_size == 1:
        ...
        return [25, 50, 75, 90, 95, 99, 100]
    elif 1000 <= sample_size < 10000:
        return [25, 50, 75, 90, 95, 99, 99.9, 100]
    else:
        return [25, 50, 75, 90, 95, 99, 99.9, 99.99, 100]
