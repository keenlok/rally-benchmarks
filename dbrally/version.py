...
from dbrally import paths
from dbrally._version import __version__
from dbrally.utils import git, io
...
def minimum_es_version():
    ...
    """
    return resources.read_text("dbrally", "min-es-version.txt").strip()
