...
from dbrally.client import delete_api_keys
from dbrally.driver import es_runner, os_runner, scheduler
from dbrally.track import TrackProcessorRegistry, load_track, load_track_plugins
from dbrally.utils import console, convert, net
    ...
    def receiveMsg_StartWorker(self, msg, sender):
        ...
        if database_type == "opensearch":
            ...
            if self.track.has_plugins:
                track.load_track_plugins(self.config, self.track.name, os_runner.register_runner, scheduler.register_scheduler)
        else:
